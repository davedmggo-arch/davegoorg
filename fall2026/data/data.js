...
window.__SENECA_DATA = {
  ...
  },
  {
    ...
    "project": "a",
    "title": "Blocking our environment",
    "oneConcept": "Blocking out an environment means finding its purpose, committing to a scale, and building shapes that serve both.",
    "checkpoint": "A1",
    "checkpointIsDelivery": false,
  ...
  projects: [
  {
    ...
    "world": "Student's chosen environment",
    "weeks": [
      2,
      3,
      4
    ...
    "prompt": null,
    "brief": "## Project Brief\n\nWelcome to the first real studio-style project of the term! We will build three environment blockouts, and the three of them can each be different, different locations are fine. What has to hold is that each blockout has a clear purpose we can state in one sentence, and that the theme and feeling we are going for comes through at the final submission. The whole process follows the visual design pipeline: we block the space, we find the purpose and scale of each blockout, and we build the shapes so the audience always knows what matters. That is the Purpose, Scale, and Shape Hierarchy spine that runs through the whole class. The funpack-style presentation gives us a clean, scannable way to show our thinking alongside the work. Three clear blockouts beat one muddy render, and that is exactly how we measure success here.\n\nThe core deliverable is a **set of three environment blockouts, each with a clear purpose, presented in a funpack-style contact sheet**. The mood board and our weekly prep work round out the package. We will cover the weekly tools and steps in the lesson plan, so we can refer back to each week for the in-depth guidance. This brief is where the big picture lives.\n\n## Themes and Timeframes\n\nWe have three different geographical themes to choose from, each rooted in a specific period, and within each theme there are three designs we can block out. We pick one theme, and the three designs we choose inside it become our three blockouts. The timeframe is not decoration. It tells us what props to place, what clothing to suggest, and what architecture to trust. Pick the theme we can see the clearest idea of, then the three designs we can commit to. Here is what is on the table:\n\n**Theme 1: Nordic Fjords and Forests (10th to 12th Century)**. Timber and stone define the built world here, cold light defines the look, and low timber framing with sod roofs carries the architecture. Choose from the **Longhouse Hearth**: a timber longhouse interior built around a raised fire pit, with benches along the long walls and a carved rune stone on a rough stone shelf as the focal point; the **Coastal Fishing Hut**: a small single-room hut at the water's edge, with nets and rope from the rafters and dried cod by the door as the focal point; or the **Mountain Hermit Cell**: a cramped stone cell cut into the rock, with a thin bed, a birch shelf, and a worn psalter open on the shelf as the focal point. Props from the era: iron-tanged axes, wool cloaks, wooden bowls, whalebone combs.\n\n**Theme 2: East Asian Mountain Temples (8th to 10th Century)**. Lacquered wood and paper define the interiors, and timber framing with tiled roofs carries the architecture. Choose from the **Kyoto Tea House Interior**: a low wooden room with tatami flooring, with shoji screens on one wall, a low table at center, and a single ceramic vessel on that table as the focal point; the **Rice Terrace Rest House**: an open-sided shelter at the edge of the rice terraces, with a crate and a bench, the terracing visible through the open side, and a weathered wooden bowl on the crate as the focal point; or the **Floating Market Stall**: a covered stall set on a waterway, with woven baskets and hanging goods, and a carved jade pendant resting on a cloth as the focal point. Props from the era: bronze mirrors, incense burners, silk sutra scrolls, lacquerware.\n\n**Theme 3: Sahel Crossroads (13th to 15th Century)**. Rammed earth and carved wood define the built world here, and mud-brick walls with wooden toron beams and carved doorways carry the architecture. Choose from the **Granary Compound Interior**: a walled courtyard of rammed-earth rooms, with carved wooden doors, woven mats on the floor, and a leather water skin on the mats as the focal point; the **Cliffside Library**: a stone reading room set into a cliff face, with a low reading stone, a shelf of bound manuscripts, and a metal inkwell on the reading stone as the focal point; or the **Savanna Lookout**: a raised thatched platform with a low wall, with woven patterns on the walls, a wooden peg, and a curved bow on the peg as the focal point. Props from the era: cowrie shell strings, leather-bound manuscripts, clay water jugs, woven baskets.\n\nEach blockout carries a *purpose*, and that purpose is a story beat, not just a postcard of a place. A beat has a before and an after: something just happened or is about to happen. A library is a noun, but the environment the moment a rare text lands on one of its tables is a beat. That difference is the heart of the whole project, and it is the thing we state in one sentence at Checkpoint A1. If a beat edges toward a heavier historical layer, we lead with the design question and the story hook first, and treat the historical context as optional background. The design carries the grade, not the history lesson.\n\n> **Aside (further reading):** *Dream Worlds: Production Design for Animation* by Hans Bacher, Chapter 3, \"Visual Development and Research.\"\n\n## Project Details\n\nThe weekly lessons will walk us through the tools and techniques step by step, so we can refer back to each week for the detailed guidance on blocking, lighting, materials, camera work, and rendering. Here is the overview of what to expect:\n\nWe start with a **starter scene** that gives us an organized file with collections, a camera, and a three-point light rig ready to go. The **Quick Sheet renderer** helps us produce a contact sheet of our three blockouts in one pass. The **file auditor** checks naming and scene hygiene before we deliver. We will use **EEVEE for daily iteration** and reserve longer renders for the delivery pass. **Week 3** introduces skyboxes: we build custom skies and clouds to set the atmosphere. **Week 4** is about adding quick details, variations, and lighting impressions to bring the scene to life. Blender is the tool for the term, and the concepts stay version-agnostic.\n\nTwo in-class checkpoints will keep us on track, each gated on a working artifact rather than the clock. **Checkpoint A1** at week two reviews our three blockouts for scale and flow. **Checkpoint A2** at week three reviews our three blockouts for genuine variety. Delivery happens at week four with the three blockout renders, funpack presentation, mood board, and a clean file. At delivery we want to hear the process, not the polish. What we killed and why is more interesting than the finished image.\n\n## Grading Rubric\n\nThe rubric for this project covers checkpoint criteria, final submission criteria, and how the grade is calculated across the three term projects. We self-assess before the instructor grades, and that comparison between our own read and the instructor's read is where the real learning happens. The full rubric breaks each dimension down with point values and rationale, so take a look before we start. The process and the thinking carry more weight than the final polish, and that is by design.\n\n## Deliverables\n\n- **Three environment blockouts**, each with a clear purpose we can state in one sentence.\n- A **funpack-style presentation** assembled from the three blockout renders, with the theme and feeling of each one coming through.\n- A **mood board** with research references.\n- A clean **.blend**, auditor-checked.\n\nNot required: animation, texture-baking, or a game-ready asset. This is design and presentation, and that is the whole of it.\n\n## Checkpoints\n\nTwo in-class checkpoints, each gating on a **working artifact**, not the clock. Checkpoints are due **Wednesday after the assignment** (marked Thursday). Answer the self-checks before we show the work.\n\n### A1: Blockout review (Wk 2)\n\n- **What to show:** the three blockouts, with basic scale and flow established in each.\n- **Focus criterion:** Does each blockout have **readable scale and a clear path through it**, or is it still a floating box with no sense of place?\n- **Self-check before we show:**\n  1. What is the purpose of each of the three blockouts, in one sentence?\n  2. Does the scale read against the mannequin in each, and where does the eye go?\n  3. If we walked through each space, what would we see first?\n\n### A2: Blockout variety review (Wk 3)\n\n- **What to show:** the contact sheet of the three blockouts showing genuine variety.\n- **Focus criterion:** Do our three blockouts show **different choices**, or three copies of the same idea?\n- **Self-check before we show:**\n  1. Which blockout is the weakest, and what specifically makes it weak?\n  2. What did we kill from early ideas, and why?\n  3. Does each blockout carry its story beat, or is it just a pretty environment?\n\n### Delivery A (Wk 4)\n\nThe three blockout renders, funpack presentation, mood board, and the clean .blend. At delivery we want to hear the process, not the polish. What we killed and why is more interesting than the finished image.\n\n## Links and Resources\n\nHere is where we will keep useful links and reference images as the term progresses. For now, the weekly lessons are the primary source of in-depth guidance, and the rubric is our grading compass. As we build, we will add mood board references, tool tips, and example funpacks right here.\n\n*Coming soon: mood board templates, funpack examples, and reference image links.*",
    "rubric": "*Three worlds, three timeframes. Fall 2026. Read this rubric like a conversation, not a form.*\n\n## How This Term Is Graded\n\nThe term is split across three projects, weighted to keep the work steady from start to finish:\n\n- **Project A = 30%** of the term grade\n- **Project B = 30%** of the term grade\n- **Project C = 40%** of the term grade\n\nProject C carries the most weight because it is the heaviest build. The split makes sure we invest effort throughout the term, not just at the end.\n\nEach project is scored on a 100-point scale. The final submission score becomes the project score, which is then weighted by the project percentage above. So a 75 out of 100 on Project A contributes 22.5 points (75 * 0.30) toward the term total.\n\n## How Each Project Is Scored\n\nEvery project is split 50/50 between checkpoints and the final submission:\n\n- **Checkpoints = 50% of the project score** (50 points available)\n- **Final Submission = 50% of the project score** (50 points available)\n\nThis means checkpoints are not a formality. Half our project grade is locked in before the final delivery, and that is intentional. We want the climb to be visible, and we want the process to carry weight.\n\n## Checkpoints\n\nCheckpoints are due **Wednesday after the assignment**. We mark them **Thursday**. This timing is not flexible. The ability to deliver on time is incredibly important. In a real studio, a missed deadline is a missed deadline, and we want the practice to land now.\n\nEach checkpoint has exactly **one criterion**: the focus of that week's lesson. We score it out of 25 points, so two checkpoints give us the 50 checkpoint points total.\n\n### A1: Blockout Review (Wk 2) | 25 pts\n\n**Criterion:** Does each blockout have readable scale and a clear path through it?\n\nThis is the only thing we are looking for at this stage. Not the materials, not the lighting, not the final camera. Just: can we walk through each space and feel like it is a place?\n\n- **20 to 25 pts:** The space reads as a real location. A human dropped in would feel the right size. There is a path the eye can follow and a focal point the eye can land on.\n- **15 to 19 pts:** The space is recognizable but scale wavers in places. The path is there but the eye gets lost partway through.\n- **1 to 14 pts:** The space reads more like a floating object than a place we can inhabit. Scale is unclear and there is no obvious path.\n\n### A2: Blockout Variety Review (Wk 3) | 25 pts\n\n**Criterion:** Do our three blockouts show genuinely different choices?\n\nNot three copies of the same render with the light nudged. Different compositions, different palettes, different focal points. Range, not repetition.\n\n- **20 to 25 pts:** The blockouts are meaningfully different. We can point to specific choices that shift between blockouts and say why each one is worth exploring.\n- **15 to 19 pts:** The blockouts have some variety, but two or more are too close to each other. The range is there but not sharp.\n- **1 to 14 pts:** The blockouts feel like the same idea repeated. There is not enough difference between blockouts to call them a range.\n\n## Final Submission Criteria\n\nThe final submission is scored out of 100 points. Those 100 points are then halved to give us the 50 points for the final submission portion of the project grade. Here are the four criteria:\n\n### 1. Adherence to Reference Material | 30 pts\n\n**Why it matters:** Directors look at this first. Can we take a brief, research it, and deliver work that matches the assigned style and world? This is the core job skill.\n\nWe are graded on how well our environment lives inside the chosen theme, its timeframe, and its design. Does the **10th-century Nordic Fjord** read as stone, timber, and cold light? Does the **9th-century East Asian Mountain Temple** carry lacquered wood, paper screens, and morning mist? Does the **14th-century Sahel Crossroads** feel like rammed earth, carved wood, and golden warmth? The timeframe shapes the props we place, the architecture we trust, and the clothing we suggest. The reference material is our north star, not a suggestion.\n\n### 2. Presentation | 30 pts\n\n**Why it matters:** Directors look at this second. Can we make our work legible to someone who has not seen the process? A great idea trapped behind a messy deliverable does not land.\n\nThis covers the funpack-style contact sheet, the mood board, the three blockouts, and how clearly the theme and feeling of each one comes through at the final submission. The presentation is communication, not decoration.\n\n### 3. Design Innovation | 20 pts\n\n**Why it matters:** This is the cool factor. Did we bring something to the table that makes us stand out, even within the reference constraints? Directors want work that surprises, and they want to hire people who do that.\n\nWe are looking for smart choices that go beyond the brief without violating it. A camera angle that tells the beat more clearly than a head-on shot. A palette that carries mood without drifting from the world. A detail that says \"this was a real place\" without reading as clutter.\n\n### 4. Organization | 20 pts\n\n**Why it matters:** Quality of life. Someone else needs to be able to open our file and follow along. Clean names, sorted collections, a readable node graph. This is not busywork. It is how we keep our own sanity.\n\nThe file auditor runs before delivery. If the auditor flags issues, those are fixable, and fixing them before we deliver is part of the grade.\n\n## Summary\n\n| Component | Points | Weight |\n|---|---|---|\n| Checkpoint A1 | 25 pts | 25% of project grade |\n| Checkpoint A2 | 25 pts | 25% of project grade |\n| Final Submission (100 pts, halved) | 50 pts max | 50% of project grade |\n| **Total Project A** | **100 pts** | **30% of term grade** |\n\nThe grade is not the render. The grade is the thinking we can defend, the decisions we can explain, and the evidence that we got there by working, not by luck. Everything else in this document is just the shape of that, aimed at our blockouts.",
    "guardrails": [],
    "deliverables": [
      "**Three environment blockouts**, each with a clear purpose we can state in one sentence.",
      "A **funpack-style presentation** assembled from the three blockout renders, with the theme and feeling of each one coming through.",
    ...
    "checkpoints": [
      {
        ...
        "week": 2,
        "name": "A1",
        "body": "- **What to show:** the three blockouts, with basic scale and flow established in each.\n- **Focus criterion:** Does each blockout have **readable scale and a clear path through it**, or is it still a floating box with no sense of place?\n- **Self-check before we show:**\n  1. What is the purpose of each of the three blockouts, in one sentence?\n  2. Does the scale read against the mannequin in each, and where does the eye go?\n  3. If we walked through each space, what would we see first?"
      },
      {
        "id": "A2",
        "week": 3,
        "name": "A2",
        "body": "- **What to show:** the contact sheet of the three blockouts showing genuine variety.\n- **Focus criterion:** Do our three blockouts show **different choices**, or three copies of the same idea?\n- **Self-check before we show:**\n  1. Which blockout is the weakest, and what specifically makes it weak?\n  2. What did we kill from early ideas, and why?\n  3. Does each blockout carry its story beat, or is it just a pretty environment?"
      },
      {
        "id": "Delivery A",
        "week": 4,
        "name": "Delivery A",
        "body": "The three blockout renders, funpack presentation, mood board, and the clean .blend. At delivery we want to hear the process, not the polish. What we killed and why is more interesting than the finished image."
      }
    ],
    "source": {
  ...
  },
  {
    ...
    "text": "File naming convention: LastName_FirstName_ANV306_wk-##_v###.filetype",
    "order": 2
  },
  {
    "id": "sub-naming-png",
    "category": "submission",
    "subCategory": "naming-convention",
    "text": "PNG sequence naming: LastName_FirstName_ANV306_wk-##_v##_###.png",
    "order": 2.5
  },
  {
    "id": "sub-collections",
    ...
    "text": "Blender Collections: the file should include the numbered top-level set - 00_world, 10_set, 20_light, 30_cam (00_world first)",
    "order": 3
  },
  {
    "id": "sub-naming-all",
  ...
  {
    "id": "mannequin",
    "title": "Adult Mannequin (scale reference)",
    "description": "FBX mannequin model used as the scale reference in the Week 02 blockouts.",
    "url": "https://filedn.com/l2sG939QiPx0rp2J0fA1ciJ/fall2026/Week%202/Adult_Mannequin_v001.fbx",
    "type": "fbx"
  },
  {
    "id": "skybox",
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "Direct the audience in each blockout: place shapes strategically and consider windows, lamps, and vignettes",
          "Save as a-environment_wk2-a1.blend with the three blockouts in clean collections and nothing orphaned"
        ],
        "hotkeys": [
          {
            "key": "Shift+D",
        ...
        "expectations": "The teacher expects three environment blockouts that can all be different, each with a purpose you can state in one sentence, a mannequin scale reference, a clear large-to-medium shape hierarchy, and the theme and feeling of each environment coming through at the final submission."
      },
      {
        "id": "materials",
        ...
        "expectations": "Materials should be simple colour placeholders that establish value contrast. The teacher checks that the focal point is the strongest value in each blockout."
      },
      {
        "id": "lighting",
      ...
      },
      {
        ...
        "description": "Place a camera to check whether the eye path in each blockout leads clearly to the focal point.",
        "steps": [
          "Add a camera and frame it to show the focal point in each blockout",
        ...
        "expectations": "The teacher expects each blockout to be checked from a camera angle that shows the eye path clearly. The focal point should be legible and well-placed in the frame."
      },
      {
        "id": "rendering",
        ...
        "steps": [
          "Press F12 for a quick EEVEE render of each blockout",
          "Check that the focal point reads in all three blockouts",
        ...
        "hotkeys": [
          {
            ...
            "imageUrl": "",
            "description": "Quick check of how each blockout reads"
          }
        ],
        "expectations": "A blockout render that shows the three blockouts, each with a readable focal point and clear scale. Rough is fine; the decisions must be clear."
      },
      {
        "id": "shortcuts",
        "title": "Effective Shortcuts",
        ...
        "steps": [
          ...
          "Press Ctrl+A to apply transforms before moving to the next blockout",
        ...
        "hotkeys": [
          ...
          },
          {
            ...
            "action": "Toggle Local View",
            "imageUrl": "",
            "description": "Isolate a blockout for focused blocking"
          }
        ],
    ...
    "sections": [
      {
        ...
        "steps": [
          ...
          "Confirm the focal point is still legible in each blockout",
      ...
      },
      {
        ...
        "expectations": "Each blockout should carry a coherent three-layer palette. The teacher checks that Central, Secondary, and Accent colours agree with the theme and serve the focal point."
      },
      {
        "id": "lighting",
      ...
      },
      {
        ...
        "description": "Frame the lit blockout to confirm the read holds from the camera angle.",
        "steps": [
      ...
      },
      {
        ...
        "description": "Render one fully set-up blockout to confirm the read before Checkpoint A1.",
        "steps": [
        ...
        "expectations": "One fully set-up blockout that reads as a place, not shapes in a gray void. The teacher checks lighting, materials, and skybox coherence."
      },
      {
        "id": "shortcuts",
        "title": "Effective Shortcuts",
